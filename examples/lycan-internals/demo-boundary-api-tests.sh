...
"$LYCAN" compile "$ROOT/examples/lycan-internals/demo_planetary_defense.lycs" >/dev/null
"$LYCAN" compile "$ROOT/examples/lycan-internals/demo_grid_blackout_prevention.lycs" >/dev/null
"$LYCAN" compile "$ROOT/examples/lycan-internals/demo_evolve_target.lycs" >/dev/null
...
install("mission-control", "mars", root / "examples/lycan-internals/demo_mars_horizons_api.lyc")
mission_policy = {
    "allow_stdout": True,
    "allow_stdin": False,
...
install("planetary-defense", "deflect", root / "examples/lycan-internals/demo_planetary_defense.lyc")
...
install("evolution-lab", "sum", root / "examples/lycan-internals/demo_evolve_target.lyc")
...
for job, target in grid_jobs:
    ...
    install(job, "blackout", root / "examples/lycan-internals/demo_grid_blackout_prevention.lyc")
