...
The supporting test in `src/shared_state_strategy.rs`
...
The Lycan-side wrapper (`src/shared_state_strategy.rs`) is
...
`docs/capsule-features/shared-state-linucb.md` for the
