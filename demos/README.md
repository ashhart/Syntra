...
| TLS gateway | [`../scripts/demo-tls-gateway.py`](../scripts/demo-tls-gateway.py) | Frontier: full decide/feedback loop through a TLS reverse proxy (TLSv1.3); wrong-CA and hostname-mismatch handshakes REJECTED, plain HTTP refused; 8/8. |
