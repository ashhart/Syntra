...
|----------|-----------------|--------|
| Go       | [`examples/syntra-go/`](https://github.com/ashhart/Syntra/tree/main/examples/syntra-go) | `syntra-go` |
| Node     | [`examples/syntra-node/`](https://github.com/ashhart/Syntra/tree/main/examples/syntra-node) | `@syntra/syntra-client` (TypeScript) |
...
[`examples/syntra-go/README.md`](examples/syntra-go/README.md)
...
[`examples/syntra-node/README.md`](examples/syntra-node/README.md).
...
[`examples/syntra-java/README.md`](examples/syntra-java/README.md).

## Rust

Cargo crate, async + sync APIs. See
[`examples/syntra-rs/README.md`](examples/syntra-rs/README.md).
