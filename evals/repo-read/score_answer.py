#!/usr/bin/env python3
"""Score a model answer against the Syntra repo-read reviewer notes."""
...
CHECKS: list[tuple[str, str]] = [
    ...
    ("demo breadth", r"(?:demo|example)s?.*(?:breadth|scope|substrate|beyond)"),
    ...
    ("pandemic scope limit", r"synthetic.*policy[- ]scoring|not an epidemiological model"),
    ("mars scope limit", r"standard orbital mechanics|not novel planning"),
    ("proof-lab scope limit", r"refuses? the open asymptotic|expert_theorem_required"),
